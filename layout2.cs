...
namespace HetDepotApplication
{
    class Program
    {
                ...
                switch (invoerbezoeker)
                {
                    ...
                    case "1":
                        ...
                        if (returnvalue == 0)
                        {
                            ...
                            List<Reservering> reserveringenlijst = new List<Reservering>();
                            reserveringenlijst.Add(reservering);


                            string strReservering = JsonConvert.SerializeObject(reserveringenlijst);
                            Console.WriteLine(strReservering);
                            File.WriteAllText(@"reservering.Json", strReservering);
                            LeegPagina();
            ...
            while(true)
            {
                ...
                switch (invoergids)
                {
                    case "1":
                        ...
                        Reservering reservering =JsonConvert.DeserializeObject<Reservering>(strReservering);
                        Console.WriteLine("\n" + strReservering);
                        Console.ReadLine();
        ...
        static void Rondleidingen()
        {
            ...
            Console.WriteLine("Plekken vrij voor vandaag:" + Reservering.plekkengereserveerd);
